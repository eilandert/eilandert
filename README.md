...
| [nginx-test-harness](https://github.com/myguard-labs/nginx-test-harness) | Functional + leak-testing harness for nginx / Angie modules, in C — in-worker JSON probe + standalone rule-file prober, fd/cycle-pool leak deltas, fault injection at allocation sites. No Perl, no banner sniffing |
